    ...
    { // 42일차 자동 설정 도구 묶음
        ...
        { // 28종 아이템 프로토타입 데이터 생성 처리
            ...
            { // 28종 아이템 프로토타입 묶음
                ...
                new ItemSeed("ITM-022", "RewindClock", "되감기 시계", "최근 5초의 안전 위치를 1.25초 동안 충돌 없이 역재생", ItemImplementationPriority.P2, ItemUseType.Instant, ItemEffectType.RewindClock, 3f, 1, 5f, 1.25f, 0f, 0f, 0f, 0f, 0f, Vector3.one * 0.5f, new Color(0.75f, 0.55f, 1f, 1f)), // P2 되감기 시계
                new ItemSeed("ITM-023", "HomingMissile", "유도탄", "가장 가까운 대상을 초당 16m로 추적해 힘 12로 밀치며 한 번 재선정", ItemImplementationPriority.P2, ItemUseType.Projectile, ItemEffectType.HomingMissile, 3f, 1, 8f, 12f, 1f, 60f, 0.35f, 0f, 16f, Vector3.one * 0.5f, new Color(1f, 0.25f, 0.15f, 1f)), // P2 유도탄
                ...
                new ItemSeed("ITM-025", "Drone", "드론", "현재 1위 대상을 초당 12m로 추적해 힘 10으로 밀치며 한 번 재선정", ItemImplementationPriority.P2, ItemUseType.Duration, ItemEffectType.Drone, 3f, 1, 12f, 10f, 1f, 60f, 0.5f, 0f, 12f, Vector3.one * 0.5f, new Color(0.45f, 0.55f, 0.65f, 1f)), // P2 드론
                ...
                new ItemSeed("ITM-027", "SniperWaterGun", "저격 물총", "최대 50m를 조준해 힘 14로 밀치고 1.5배부터 4배까지 배율 변경", ItemImplementationPriority.P2, ItemUseType.Instant, ItemEffectType.SniperWaterGun, 3f, 1, 0f, 14f, 0f, 50f, 0f, 0f, 0f, Vector3.one * 0.5f, new Color(0.1f, 0.55f, 0.95f, 1f)), // P2 저격 물총
                new ItemSeed("ITM-028", "Cart", "카트", "가까운 연결 경로를 초당 10m 속도로 최대 8초 자동 주행", ItemImplementationPriority.P2, ItemUseType.Duration, ItemEffectType.Cart, 3f, 1, 8f, 10f, 0f, 4f, 0f, 0f, 0f, Vector3.one * 0.5f, new Color(0.85f, 0.25f, 0.2f, 1f)) // P2 카트
            }; // 28종 아이템 프로토타입 묶음 종료
